...
(isset($context["origin"]) || array_key_exists("origin", $context))) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none")))));
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_update.html.twig", "C:\\OSPanel\\domains\\prestaTest\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\grid_notification_update.html.twig");
    }
}
